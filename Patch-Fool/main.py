...
def get_aug():
    ...
    parser.add_argument('--network', default='DeiT-B', type=str, choices=['vit_base_patch16_224','DeiT-B', 'DeiT-S', 'DeiT-T',
...
def main():
    ...
    for i, (X, y) in enumerate(loader):
        ...
        model.zero_grad()
        if 'DeiT' in args.network or 'vit' in args.network:
        ...
        with torch.no_grad():
            if args.sparse_pixel_num == 0 or args.random_sparse_pixel:
                ...
                if 'vit' in args.network or 'DeiT' in args.network:
